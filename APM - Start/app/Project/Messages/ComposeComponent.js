...
var ComposeComponent = (function () {
    function ComposeComponent(_router, _userService) {
    ...
    ComposeComponent.prototype.send = function () {
        var _this = this;
        var s = this.Message;
        var splitted = s.slice(0, 30);
        var date = new Date().toLocaleDateString();
        var time = new Date().toLocaleTimeString();
        var dateTime = date + ' ' + time;
        this._userService.sendMessage(this.userFirstName, this.Recipient, splitted, this.Message, dateTime).subscribe(function (data) {
            _this.response = data;
        });
        this.Recipient = "";
        this.Message = "";
    };
    ComposeComponent.prototype.profile = function () {
        this._router.navigate(['/Profile']);
    };
    ComposeComponent.prototype.Logout = function () {
        this._userService.Logout();
        this._router.navigate(['/Login']);
    };
    ComposeComponent.prototype.messages = function () {
...
//# sourceMappingURL=ComposeComponent.js.map